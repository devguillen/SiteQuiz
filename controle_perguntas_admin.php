...
<head>
    ...
    .action-buttons a {
    display: block;
    margin-right: 20px /* Espaçamento maior entre os botões */
    padding: 8px 12px;
    border-radius: 6px;
    text-decoration: none;
    color: #fff;
...
.action-buttons .btn-editar:hover {
    background-color:rgb(27, 153, 67);
}
...
.action-buttons .btn-excluir:hover {
...
<nav class="navbar">
  ...
  <ul class="nav-links">
    <li><a href="admin.html">Cadastrar Perguntas</a></li>
  </ul>
...
<body>
    ...
    <a href="editar_pergunta.php?id=<?= $pergunta['id'] ?>" class="btn-editar">Editar</a>
    <a href="excluir_pergunta.php?id=<?= $pergunta['id'] ?>" class="btn-excluir" onclick="return confirm('Tem certeza que deseja excluir esta pergunta?')">Excluir</a>
</td>
